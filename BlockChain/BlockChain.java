...
public class BlockChain {
    ...
    public boolean addBlock(Block block) {
        ...
        if (blockParentNode.height < maxHeightBlockNode.height - CUT_OFF_AGE) {
            return false;
        }
