...
public class Transaction {
	...
	//and a digital signature. For the input to be valid, the signature it contains must be 
	//a valid signature over the current transaction with the public key (receiver) in the spent output.
	
	
	//checkValidity(signature, msg, publicKey)
    ...
    public void addOutput(double value, PublicKey pk) {
        Output op = new Output(value, pk);
        outputs.add(op);
    }
